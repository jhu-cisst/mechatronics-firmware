...
`define BROADCAST_MAC 48'hFFFFFFFFFFFF
...
`define LCSR_CID    24'hfa610e
`define FPGA_RT_MAC 16'h1394
`define FPGA_PS_MAC 16'h0300
...
`define MULTICAST_BIT      24'h010000
`define LCSR_CID_MULTICAST (`LCSR_CID | `MULTICAST_BIT)
...
`define UDP_MULTICAST 24'h01005e

// Default UDP multicast IP address (224.0.0.100)
`define UDP_MULTICAST_FPGA_DEFAULT 32'he0000064
