...
`ifdef USE_VIVADO
    for (i=  1; i<100; i=i+1) ROM_PWM[i] = 20*i + 20;
    for (i=100; i<200; i=i+1) ROM_PWM[i] = 2000 - 20*(i-99);
`else
...
`ifdef USE_VIVADO
    for (i=400; i<500; i=i+1) ROM_PWM[i] = 20*(i-400) + 20;
    for (i=500; i<600; i=i+1) ROM_PWM[i] = 2000 - 20*(i-499);
    for (i=600; i<700; i=i+1) ROM_PWM[i] = 20*(i-600) + 20;
    for (i=700; i<800; i=i+1) ROM_PWM[i] = 2000 - 20*(i-699);
`else
