...
#-----------------------------------------------------------------------------
add_files -norecurse {../example_design/example_ila_write_trig.v}
#add_files -norecurse {../example_design/example_ila_write_trig.ucf}
set_property target_constrs_file {../example_design/example_ila_write_trig.ucf} [current_fileset -constrset]
import_ip -file {chipscope_icon.xco} -name chipscope_icon
generate_ip -files {../../../chipscope_icon_v1_06_a_0/chipscope_icon.xco}
set_property top example_ila_write_trig [get_filesets sources_1]
